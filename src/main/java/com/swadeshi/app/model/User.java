...
public class User {
    ...
    public User(Long id, String firstName, String lastName, String password, String email, String gender, int role,
            String mobile, List<Address> addresses, List<PaymentInformation> paymentInformation, List<Rating> ratings,
            List<Review> reviews, LocalDateTime add_Date, LocalDateTime updated_Date) {
        super();
        this.id = id;
